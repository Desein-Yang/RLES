...
'''
@File    :   Preprocess.py
@Time    :   2019/10/21 20:29:05
@Author  :   Qi Yang
@Version :   1.0
@Describtion:   preprocessing obervation of env and it has been tested successfully.
...
class AtariPreprocessing(gym.Wrapper):
    ...
    Mnih 2015 Deep Q-learning Network preprocess
